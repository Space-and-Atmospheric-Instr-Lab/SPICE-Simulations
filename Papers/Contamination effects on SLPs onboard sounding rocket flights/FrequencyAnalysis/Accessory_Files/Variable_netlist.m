...
function raw_data = Variable_netlist(PUWULstring,tend,Ni,Te,Rc,Cc,ICS,max_time_step)
...
code = [';Comment to Initialize\r\n'...
        ...
        '.IC V(1) = SAVEDV1 V(3) = SAVEDV3 V(4) = SAVEDV4\r\n'...
        '.OP\r\n'...
        '.TRAN 1e-7 TEND 0 TIMESTEPSTRING \r\n'...
    ...
    code = strrep(code,'TIMESTEPSTRING',num2str(max_time_step));
    ...
    code = strrep(code,'SAVEDV1',ICS{1});
    code = strrep(code,'SAVEDV3',ICS{2});
    code = strrep(code,'SAVEDV4',ICS{3});
